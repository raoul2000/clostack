...
(deftest add-item-to-list-test
  ...
  (testing "adding todo item to non empty todo list"
    (is (= {"id1" #:todo{:text "description",     :done false},
           ...
           (db/add-item-to-list {"id1" #:todo{:text "description", :done false}}
                                "id2"
...
(deftest add-item-to-db-test
  ...
  (testing "add a todo item to an non-empty db"
    (is (= {:todo/list         {"id1" #:todo{:text "description id1"   :done false}
                                "id2" #:todo{:text "description id2"   :done false}}
            :todo/ordered-ids '("id2" "id1")}

           (db/add-item {:todo/list         {"id1" #:todo{:text "description id1" :done false}}
                         :todo/ordered-ids '("id1")}
                        "id2"
  ...
  (testing "add duplicate todo item does not change db"
    (is (= {:todo/list         {"id1" #:todo{:text "description 1"  :done false}
           ...
           (db/add-item {:todo/list         {"id1" #:todo{:text "description 1"  :done false}
                                             "id2" #:todo{:text "description 2"  :done false}}
                         :todo/ordered-ids '("id2" "id1")}
                        "id2"
...
(deftest delete-item-test
  (testing "delete item from db"
    (let [db  {:todo/list         {"id1" #:todo{:text "description 1"   :done false}
                                   "id2" #:todo{:text "description 2"   :done false}
  ...
  (testing "deleting item not present in db"
    (let [db  {:todo/list         {"id1" #:todo{:text "description"  :done false}
                                   "id2" #:todo{:text "description"   :done false}}
...
(deftest commit-edit-todo-item-test
  (testing "commit editing an existing item"
    (is (= {"id1" {:todo/text "updated 1"  :todo/done true}
            "id2" {:todo/text "text2"      :todo/done true}}
           (db/commit-edit-todo-item {"id1" {:todo/text "text1"   :todo/done false}
                                      "id2" {:todo/text "text2"   :todo/done true}}
                                     "id1"
                                     (db/create-todo-item "updated 1" true)
                                     "new-id"))))
  (testing "commit a new item"
    (is (= {"id1"    {:text "text1"       :done false}
            "new-id" {:text "updated 2"   :done true}
            "id2"    {:text "text2"       :done false}}
           (db/commit-edit-todo-item {"id1"                {:text "text1"    :done false}
                                      db/temporary-item-id {:text "text2"    :done true}
                                      "id2"                {:text "text2"    :done false}}
                                     db/temporary-item-id
                                     {:text "updated 2"  :done true}
                                     "new-id")))))
